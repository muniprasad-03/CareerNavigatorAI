    ...
    <div className="max-w-md mx-auto bg-white p-8 rounded-xl shadow-md mt-10 border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} required/>
        </div>
        <div>
        ...
        <button type="submit" className="w-full bg-blue-600 text-white font-bold py-2 rounded-md hover:bg-blue-700 transition duration-300">Sign Up</button>
      </form>
    </div>
  );
};
